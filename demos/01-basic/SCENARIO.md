...
- A **Visa** PAN (`411111******1111`) - a valid Luhn test number.
- A **Mastercard** PAN written with spaces (`550000******0004`).
- An **Amex** PAN written with hyphens (`378282*****0005`).
- A labeled **CVV** (stored as a JSON field with key `cvv` and a 3-digit value).

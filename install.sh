#!/usr/bin/env sh
# Universal installer for panhound. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/panhound.git"
echo "Installing panhound ..."
